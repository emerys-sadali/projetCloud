...
function createSessionJWT (Id_u) {
    // ci-dessous, on met en place le cookie de session JWT :
    // 1/ on récupère notre clef privée
    ...
    // on récupérera ultérieurement ces informations, qui permettront
...
function decodeSessionCookie(req) {
    // si l'on n'a pas de cookie de session, on renvoie une session vide,
